...
from exception_layer.data_access_exception.mongo_db_exception import MongoDbException
    ...
    def get_database_client_object(self):
        ...
        try:
            ...
            client = pymongo.MongoClient(self.get_mongo_db_url(),
                                         ssl_cert_reqs=ssl.CERT_NONE, tlsAllowInvalidCertificates=ssl_options
